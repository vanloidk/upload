#!/bin/sh
#
WORKING_DIRECTORY_FOLDER=/home/ebanking/scb-config-service
...
SERVICE_TITLE_SYSTEMD='config-service'
#
...
then
	...
	$USER_EXCUTE_SERVICE ALL=(root) NOPASSWD: /bin/systemctl reset-failed $SERVICE_NAME_SYSTEMD
